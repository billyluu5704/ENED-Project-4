...
startofshelves(box, tp0, tp1, tp2, tp3, tp4, st1, st2, st3, st4, st5, s, gyro,b1, b2, b3, b4, b5, b6)
...
def backtob(b1, b2, b3, b4, b5, b6, gyro,box, s):
    if box == 7:
        robot.straight(b5 + s * 2 + b6 + s)
    elif box == 8:
        robot.straight(b4 + s * 2 + b6 + s)
    elif box == 9:
        robot.straight(b3 + s * 2 + b6 + s)
    elif box == 10:
        robot.straight(b2 + s * 2 + b6 + s)
    elif box == 11:
        robot.straight(b1 + s * 2 + b6 + s)
    elif box == 12:
        robot.straight(s * 2 + b6 + s)
    robot.stop()
    m_left.brake()
    m_right.brake()
    turn_right(a, gyro)
